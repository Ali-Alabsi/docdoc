...
class TextStyles {
  ...
  static TextStyle font16WhiteColorW600 =  TextStyle(
    ...
    static TextStyle font24MainColorColorW700 =  TextStyle(
    fontSize: 24.sp,
    color: ProjectColors.mainColors,
    fontWeight: FontWeight.w700
  );

  static TextStyle font14garyterColorsColorW400 =  TextStyle(
    fontSize: 14.sp,
    color: ProjectColors.garyterColors,
    fontWeight: FontWeight.w400
  );

   static TextStyle font12MainColorW400 =  TextStyle(
    fontSize: 12.sp,
    color: ProjectColors.mainColors,
    fontWeight: FontWeight.w400
  );
